		...
		if($_SESSION['admin_login'] == true) {
			...
			if($_SERVER['REQUEST_METHOD'] == "POST") {
				if(isset($_POST['chkId'])) {
					$chkId = $_POST['chkId'];
					foreach($chkId as $id) {
						$query_deleteUnit = "DELETE FROM units WHERE unit_id='$id'";
...
<body>
	...
	<section>
		...
		<table class="table_displayData">
			...
			<tr>
				<td> <input type="checkbox" name="chkId[]" value="<?php echo $row_selectUnit['unit_id']; ?>" /> </td>
				<td> <?php echo $i; ?> </td>
				<td> <?php echo $row_selectUnit['unit_name']; ?> </td>
				<td> <?php echo $row_selectUnit['unit_details']; ?> </td>
				<td> <a href="edit_unit.php?id=<?php echo $row_selectUnit['unit_id']; ?>"><img src="../images/edit.png" alt="edit" /></a> </td>
			</tr>
			<?php $i++; } ?>
		</table>
