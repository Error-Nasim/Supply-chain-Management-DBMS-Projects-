<?php
	...
	if(isset($_SESSION['admin_login'])) {
		if($_SESSION['admin_login'] == true) {
			$id = $_GET['id'];
			$query_selectUnitDetails = "SELECT * FROM units WHERE unit_id='$id'";
			...
			if($_SERVER['REQUEST_METHOD'] == "POST") {
				...
				if($unitName != null) {
					$query_UpdateUnit = "UPDATE units SET unit_name='$unitName',unit_details='$unitDetails' WHERE unit_id='$id'";
...
<body>
	...
	<section>
		...
		<li>
			<input type="submit" value="Update Unit" class="submit_button" />
