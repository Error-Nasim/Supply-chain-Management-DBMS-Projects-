...
<body>
	...
	<section>
		...
		<li>
			...
			<div class="input-box"> <input type="text" id="areaName" name="txtAreaName" placeholder="e.g., Dhaka Metropolitan, Chittagong Division" value="<?php echo $areaNameHolder; ?>" required /> </div> <span class="error_message"><?php echo $areaNameErr; ?></span>
		</li>
		<li>
			<div class="label-block"> <label for="areaCode">Area Code</label> </div>
			<div class="input-box"> <input type="text" id="areaCode" name="txtAreaCode" placeholder="e.g., DHK, CTG, SYL" value="<?php echo $areaCodeHolder; ?>" required /> </div>
		</li>
		<li>
			<input type="submit" value="Add Area" class="submit_button" />
