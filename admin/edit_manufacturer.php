...
<body>
	...
	<section>
		...
		<li>
			...
			<div class="input-box"> <input type="text" id="manufacturer:name" name="txtManufacturerName" placeholder="e.g., Dhaka Food Industries, Bengal Manufacturing" value="<?php echo $row_selectManDetails['man_name']; ?>" required /> </div> <span class="error_message"><?php echo $nameErr; ?></span>
		</li>
		<li>
		...
		<li>
			...
			<div class="input-box"> <input type="text" id="manufacturer:phone" name="txtManufacturerPhone" placeholder="e.g., 01712345678, 02-9876543" value="<?php echo $row_selectManDetails['man_phone']; ?>" /> </div> <span class="error_message"><?php echo $phoneErr; ?></span>
		</li>
		<li>
		...
		<li>
			<input type="submit" value="Update Manufacturer" class="submit_button" />
