...
<body>
	...
	<section>
		...
		<li>
			...
			<div class="input-box"> <input type="text" id="retailer:phone" name="txtRetailerPhone" placeholder="e.g., 01712345678, 02-9876543" value="<?php echo $row_selectRetailer['phone']; ?>" /> </div> <span class="error_message"><?php echo $phoneErr; ?></span>
		</li>
		<li>
		...
		<li>
			...
			<div class="input-box"> <textarea type="text" id="retailer:address" name="txtRetailerAddress" placeholder="e.g., House 15, Road 5, Dhanmondi, Dhaka-1205"><?php echo $row_selectRetailer['address']; ?></textarea> </div>
		</li>
		<li>
